...
# with open("xgboost_brazil_house.bin", 'rb') as f:
#     model = pickle.load(f)

# Load the RandomForest model
with open("mysite/bin/sklearn_rf_brazil_house.bin", 'rb') as f:
    model_rf = pickle.load(f)

# Load the Dictionary Vectorizer   
with open("mysite/bin/dictvec.bin",'rb') as dv:
